...
insert into auth_user (auth_user_id,first_name,last_name,email,password,status) values (1,'Vinayak','Marraiya','admin@gmail.com','$2a$10$e59rGaFvpijWXLh03j0aZOzBYQNrIRIjlB8sGwLvBL35fecblsW1m','VERIFIED');
